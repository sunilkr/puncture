...
void Image_ADVAPI32(IMG img, void *v)
{
	...
	for(SYM sym = IMG_RegsymHead(img); SYM_Valid(sym); sym = SYM_Next(sym))
	{
		...
		if("RegOpenKeyExA" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"ADVAPI32.DLL"<<DELIM<<"RegOpenKeyExA"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
		...
		else if("RegOpenKeyExW" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"ADVAPI32.DLL"<<DELIM<<"RegOpenKeyExW"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
		...
		else if("RegCreateKeyExA" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"ADVAPI32.DLL"<<DELIM<<"RegCreateKeyExA"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
		...
		else if("RegCreateKeyExW" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"ADVAPI32.DLL"<<DELIM<<"RegCreateKeyExW"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
		...
		else if("RegQueryValueExA" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"ADVAPI32.DLL"<<DELIM<<"RegQueryValueExA"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				RTN_Open(rtn);
		...
		else if("RegQueryValueExW" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"ADVAPI32.DLL"<<DELIM<<"RegQueryValueExW"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				RTN_Open(rtn);
				RTN_InsertCall(rtn, IPOINT_BEFORE, AFUNPTR(b4RegQueryValueEx),
		...
		else if("RegSetValueExA" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"ADVAPI32.DLL"<<DELIM<<"RegSetValueExA"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				RTN_Open(rtn);
		...
		else if("RegDeleteKeyExA" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"ADVAPI32.DLL"<<DELIM<<"RegDeleteKeyExA"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				RTN_Open(rtn);
		...
		else if("RegDeleteKeyExW" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"ADVAPI32.DLL"<<DELIM<<"RegDeleteKeyExW"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				RTN_Open(rtn);
				RTN_InsertCall(rtn, IPOINT_BEFORE, AFUNPTR(b4RegDeleteKeyEx),
					IARG_ADDRINT, 'W', IARG_FUNCARG_ENTRYPOINT_VALUE, 0,
					IARG_FUNCARG_ENTRYPOINT_VALUE, 1, IARG_END);
...
void Image_Kernel32(IMG img, void *v)
{
	...
	for(SYM sym = IMG_RegsymHead(img); SYM_Valid(sym); sym = SYM_Next(sym))
	{
		...
		if("CreateFileW" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"KERNEL32.DLL"<<DELIM<<"CreateFileW"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				/*
				RTN_Open(rtn);
		...
		else if("ReadFile" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"KERNEL32.DLL"<<DELIM<<"ReadFile"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
		...
		else if("ReadFileEx" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"KERNEL32.DLL"<<DELIM<<"ReadFileEx"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				/*
		...
		else if("WriteFileEx" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"KERNEL32.DLL"<<DELIM<<"WriteFileEx"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				/*
		...
		else if("DeleteFileW" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"KERNEL32.DLL"<<DELIM<<"DeleteFileW"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				RTN_Open(rtn);
				RTN_InsertCall(rtn, IPOINT_BEFORE, (AFUNPTR) b4DeleteFile,
		...
		else if("SetFilePointer" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"KERNEL32.DLL"<<DELIM<<"SetFilePointer"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				RTN_Open(rtn);
...
/*		else if("SetFilePointerEx" == sUndecFuncName)
		...
		else if("CloseHandle" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				 wLogFile<<"KERNEL32.DLL"<<DELIM<<"CloseHandle"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				 //RTN_Open(rtn);
...
void Image_WS2_32(IMG img, void *v)
{
	...
	for(SYM sym = IMG_RegsymHead(img); SYM_Valid(sym); sym = SYM_Next(sym))
	{
		...
		if("socket" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"WS2_32.DLL"<<DELIM<<"socket"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
				/*RTN_Open(rtn);
		...
		else if("connect" == sUndecFuncName)
		{
			...
			if(RTN_Valid(rtn))
			{
				wLogFile<<"WS2_32.DLL"<<DELIM<<"connect"<<DELIM<<"@"<<hex<<RTN_Address(rtn)<<dec<<endl;
